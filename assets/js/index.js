!(function (e) {
    ...
    function (e, t, n) {
     ...
     (t.init = function (e, h, v) {
      ...
      (r = t.renderer = e),
       ...
       (t.clearMaterial = new i.RawShaderMaterial({
        uniforms: { u_color: { value: new i.Vector4() } },
        depthTest: !1,
        depthWrite: !1,
       ...
       (t.copyMaterial = new i.RawShaderMaterial({ uniforms: { u_texture: { value: void 0 } }, depthTest: !1, depthWrite: !1, transparent: !0, blending: i.NoBlending, vertexShader: t.vertexShader, fragmentShader: t.precisionPrefix + n(29) })),
      ...
      m.translate(0.5, -0.5, 0),
       (f = new i.RawShaderMaterial({
        uniforms: { u_texture: { value: null }, u_transform: { value: new i.Vector4(0, 0, 1, 1) } },
      ...
      (t.createDataTexture = function (e, n, r, o, a, s) {
       return new i.DataTexture(
        e,
        n,
        r,
        o ? i.RGBAFormat : i.RGBFormat,
        s ? t.dataFloatType : i.UnsignedByteType,
        i.UVMapping,
        i.ClampToEdgeWrapping,
        i.ClampToEdgeWrapping,
        a ? i.NearestFilter : i.LinearFilter,
        a ? i.NearestFilter : i.LinearFilter
       );
      }),
      (t.getColorState = v),
     ...
     function v(e) {
      return { autoClear: (e = e || r).autoClear, autoClearColor: e.autoClearColor, autoClearStencil: e.autoClearStencil, autoClearDepth: e.autoClearDepth, clearColor: e.getClearColor().getHex(), clearAlpha: e.getClearAlpha() };
     }
    },
    function (e, t, n) {
     "use strict";
     ...
     var i = void 0,
      ...
      l =
       ((t.videoFormat = h("video", ["video/mp4", "video/ogv"])),
       (t.audioFormat = h("audio", ["audio/mp3", "audio/ogg"])),
    ...
    function (e, t, n) {
     ...
     function m(e, t, n) {
      ...
      this.loadedWeight === this.totalWeight
       ? ((this.isLoading = !1), (this.loadedWeight = 0), (this.totalWeight = 0), (this.loadingSignal = new r()), this._onLoading(e, t, a, 1, 1), e && e.noCache && p(e))
       : (this._onLoading(e, t, a, 1, this.loadedWeight / this.totalWeight), e && e.noCache && p(e), n || this.loadNext());
     }
     function p(e) {
      var t = e.url;
    ...
    function (e, t, n) {
     ...
     (t.init = function () {
      ...
      var e = t.inputTarget;
      t.hasTouch
       ? (e.addEventListener("touchstart", M, !0),
         e.addEventListener("touchmove", P, !0),
         l.addEventListener("touchend", R, !0),
         e.addEventListener("mousedown", M, !0),
         e.addEventListener("mousemove", P, !0),
         l.addEventListener("mouseup", R, !0),
         e.addEventListener("mousewheel", T, !0),
         e.addEventListener("DOMMouseScroll", T, !0))
       : f
       ? (e.addEventListener("mousedown", M, !0), e.addEventListener("mousemove", P, !0), l.addEventListener("mouseup", R, !0), e.addEventListener("mousewheel", T, !0), e.addEventListener("DOMMouseScroll", T, !0))
       : (e.attachEvent("onmousedown", M), e.attachEvent("onmousemove", P), l.attachEvent("onmouseup", R), e.attachEvent("onmousewheel", T));
     ...
     function A(e, n) {
      var r,
       ...
       l,
       b,
       S = { originalEvent: (e = e || u.event), button: e.button, preventDefault: C(e) },
       T = e.type,
      ...
      if ((t.isFirstTouch === i && (t.isFirstTouch = A), A))
       for (
        c = e.touches.length ? e.touches[0] : e.changedTouches[0],
         S.x = a = c.pageX,
         S.y = s = c.pageY,
         S.target = b = c.target,
         ...
         l = t.currentBubbleHistory = S.bubbleHistory = [];
        b;
   
       )
        l.unshift(b), !D && I(b, R) && (D = S.isSkipPreventDefault = !0), (b = b.parentNode);
      else
       for (
        S.identifier = 0,
        ...
        l.unshift(b), !D && I(b, R) && (D = S.isSkipPreventDefault = !0), (b = b.parentNode);
      if (((t.x = a), (t.y = s), P)) {
       for (m = !0, p = _ = M, g = y = a, x = w = s, t.downBubbleHistory = l, r = l.length; r--; )
        (o = l[r]), A && o[v + "over"] && ((S.currentTarget = o), o[v + "over"].call(o, S)), o[v + "down"] && ((S.currentTarget = o), o[v + "down"].call(o, S));
       d = D;
      }
      d || S.preventDefault(),
     ...
     function D(e) {
      for (var n, i = t.prevBubbleHistory, r = e.bubbleHistory.length; r--; )
       ((n = e.bubbleHistory[r])[v + "over"] || n[v + "out"]) && (o(i, n) || n[v + "isHover"] || ((n[v + "isHover"] = !0), n[v + "over"] && ((e.currentTarget = n), n[v + "over"].call(n, e))));
     }
     function L(e) {
     ...
     function z(e) {
      ...
      n || ((e.distanceX = t.distanceX), (e.distanceY = t.distanceY)),
       ...
       t.isPossibilyScrollH ||
        t.isPossibilyScrollV ||
        !t.isDown ||
        (e.distance > t.possibilyScrollDist && (Math.abs(e.distanceX) > Math.abs(e.distanceY) ? ((t.isPossibilyScrollH = !0), t.onSwipeH.dispatch(e)) : ((t.isPossibilyScrollV = !0), t.onSwipeV.dispatch(e))));
     ...
     (m.constructor = e.exports = h),
      (m.preInit = function () {
       ...
       this.usePostprocessing &&
        (x || (x = new l(null, this.useDepthTexture && c.IS_SUPPORT_DEPTH_TEXTURE)), (this.sharedPostprocessing = x), (this.boundBeforeRender = this.beforeRender.bind(this)), (this.boundAfterRender = this.afterRender.bind(this)));
       (this.scene = this.scene || new i.Scene()),
        (this.camera = this.camera || new i.PerspectiveCamera(this.defaultCameraFov, 1, 0.01, 400)),
        ...
        (this.isOnFocus = !1),
        (this.screenUvInfoUniform = { value: new i.Vector4() }),
        (this.aspectUniform = { value: new i.Vector2() }),
        (this.visualUvInfoUniform = { value: new i.Vector4() }),
        (this.parallaxRatioUniform = { value: new i.Vector4() }),
        (this.sharedUniforms = {});
      }),
      ...
      (m.testViewport = function (e) {
       v.testViewport.call(this, e),
        (e || this.needsRender) &&
         ...
         this.screenUvInfoUniform.value.set(this.left, Math.max(0, this.viewportTop - this.top), 1 / r.width, 1 / r.height),
         ...
         (this.lowInRatio = s.cUnMix(r.height, 0.5 * (r.height - this.height), this.top)),
         (this.upInRatio = s.cUnMix(0, 0.5 * (r.height + this.height), this.bottom)),
      ...
      (m.updateMouse = function (e, t, n, i) {
       ...
       this.mouse.set(2 * ((r.elasticMouse.x - this.left) / a - 0.5), 2 * (0.5 - (r.elasticMouse.y - this.top) / s)),
        p.origin.setFromMatrixPosition(this.camera.matrixWorld),
        p.direction
         .set((this.mouse.x + n) * e, (this.mouse.y + i) * t, 0.5)
       ...
       e.setClearColor(this.backgroundColor, 1),
        this.usePostprocessing
         ? ((x.queue = this.postprocessingQueue),
           x.scissorRect.set(this.left, this.top, this.width, this.height),
           (x.useScissor = !0),
           (x.beforeRenderOut = this.boundBeforeRender),
           (x.afterRenderOut = this.boundAfterRender),
           x.render(this.scene, this.camera, this.postprocessingToScreen))
         : this.sceneRenderTarget
         ? (e.setScissorTest(!1), this.sceneRenderTarget.setSize(this.width, this.height), this.beforeRender(e), e.setRenderTarget(this.sceneRenderTarget), e.render(this.scene, this.camera), e.setRenderTarget(null), this.afterRender(e))
         : (e.setRenderTarget(null),
           e.setScissorTest(!0),
           e.setViewport(this.left, r.height - this.top - this.height, this.width, this.height),
           e.setScissor(this.left, r.height - this.top - this.height, this.width, this.height),
           this.beforeRender(e),
       ...
       R !== (e = e || "default") &&
        ...
        (function (e) {
         if (!y[e]) {
          ...
          S[e] && S[e].kill(), (w[e] = 0);
          var n = {};
          (n[e] = 1), C && (n.delay = 0.5), (S[e] = u.to(w, 1.5, n));
         }
        })(e));
       C = !1;
      }),
    ...
    function (e, t, n) {
     ...
     (s.preInit = function (e) {}),
      ...
      (s.preShow = function (e) {
       (this.currentRefId = this.getRefIdFormPathInfo(e)), (this.currentDom = this.domCaches[this.currentRefId]), this.hasInitialized || this.init(e);
    ...
    function (e, t, n) {
     ...
     (t.init = function () {
      ...
      (t.resize = function (e, t) {
       (M = _.width = e), (P = _.height = t), (R = P + 2 * (C = 0.4 * t));
      }),
      (t.start = function (e) {
       e && F && F.kill();
       (t.percent = 0),
      ...
      (t.update = function (e) {
       if ((t.visibleRatio = Math.min(this.showRatio, 1 - this.hideRatio)) > 0) {
        ...
        if ((y.fillRect(0, r, M, P), t.showRatio < 1 && y.drawImage(A, 0, r + P - 1, M, C), t.hideRatio > 0 && y.drawImage(I, 0, r - C + 1, M, C), !T)) {
         t.percentShowRatio;
         y.save(), (y.globalAlpha = s.cUnMix(0.75, 1, this.showRatio)), y.translate(100 + (i.width >> 1) + 200 * (1 - t.percentShowRatio), ((i.height - (i.width > 1280 ? 0 : o.HEIGHT)) >> 1) + (i.width > 1280 ? 0 : o.HEIGHT));
         var u = 200 * a.easeInOutCubic(1 - s.cUnMix(0, 0.5, this.hideRatio));
     ...
     function V() {
      T ? H() : c.to(t, d ? 0 : 0.65, { percentShowRatio: 0, onComplete: H, ease: "easeInOutQuint" });
     }
     function H() {
      r.enable(!0),
       (w = !1),
    ...
    function (e, t, n) {
     ...
     var i = n(5),
      ...
      g = n(2),
      x = n(48),
      _ = { home: n(120), about: n(162), project: n(179) },
      y = [],
      w = [];
     (t.preInit = function () {
      for (var e in _)
      ...
      (t.scrollTo = se),
      (t.update = function (e) {
       oe(), (U += b._tPos < -1 ? -0.03 : 0.05), (U = g.clamp(U, 0, 1)), (O.opacity = U), !k && E < 1 && E !== b._tPos && ((k = !0), v.setBaseText(""));
         ...
         i.showTransition
          ? i.loadHTML
            ? ((R = !0),
              ...
              f.show(),
              f.start(!1))
            : ((R = !1), i.dom === M || (((P = i.dom).style.display = "none"), T.insertBefore(P, T.childNodes[0]), f.showAndHide()))
    ...
    function (e, t, n) {
     ...
     (t.preInit = function () {
      ...
      (t.init = function () {
       ...
       (f = new u({ refDom: e })),
        (h = new s({ dom: e, splitWith: "<br>", forceSplitWidth: !0, delayWeight: 0.2 })),
        (e = document.getElementById("featured-desc")),
        (v = new u({ refDom: e })),
        (m = new s({ dom: e, delayWeight: 0.2 })),
      ...
      (t.update = function (e) {
       if (p) {
        f.testViewport(),
         f.bottom > 0 && f.top < 0.65 * r.height ? g || ((g = !0), h.show(1.5)) : f.top > r.height && g && ((g = !1), h.hide(0)),
         v.testViewport(),
         v.bottom > 0 && v.top < 0.75 * r.height ? x || ((x = !0), m.show(1.5)) : v.top > r.height && x && ((x = !1), m.hide(0));
        for (var t = [[0, Math.abs(f.top + 0.5 * f.height - 0.5 * r.height)]], n = 0, a = l.length; n < a; n++) {
         var s = l[n];
    ...
    function (e, t, n) {
     ...
     function s(e) {
      (e = o({}, e)),
       ...
       u.constructor.call(this, o({ uniforms: { u_weightsTexture: { value: this.weightsRenderTarget.texture }, u_resolutionInv: this.uResolutionInv }, vertexShader: i.precisionPrefix + n(100), fragmentShader: i.precisionPrefix + n(101) }, e)),
    ...
    function (e, t, n) {
     ...
     (t.add = function (e, t, o, c) {
      d ||
       ...
       (d = new i.RawShaderMaterial({ uniforms: (f = { u_texture: { value: null }, u_textureSize: { value: new i.Vector2() } }), depthTest: !1, depthWrite: !1, vertexShader: r.vertexShader, fragmentShader: r.precisionPrefix + n(118) })));
    ...
    function (e, t, n) {
     ...
     (t.init = function (e) {
      ...
      for (var t = new Float32Array(4 * D), U = 0, N = 0; N < D; N++) (t[U + 0] = Math.random() - 0.5), (t[U + 1] = Math.random() - 0.5), (t[U + 2] = Math.random()), (t[U + 3] = N / D), (U += 4);
      ...
      if (((a.renderer.autoClearColor = !1), r.useFloatPacking)) {
       ...
       O(t, V, H),
        ...
        (u.u_posPackDividers = { value: new i.Vector2(F, z) }),
        (u.u_velPackDividers = { value: new i.Vector2(E, k) });
      ...
      (P = new i.BufferGeometry()).setAttribute("position", new i.BufferAttribute(ue, 3)),
       ...
       (C = new i.RawShaderMaterial({ uniforms: R.uniforms, vertexShader: R.vertexShader, fragmentShader: R.fragmentShader })),
       i.Material.prototype.copy.call(C, R),
       (R.defines.IS_FIRST_NODE = !0),
       r.useFloatPacking &&
        ((R.uniforms.u_positionTextureZW = u.u_currPositionTextureZW), (R.uniforms.u_posPackDividers = u.u_posPackDividers), (R.uniforms.u_rotPackDividers = u.u_rotPackDividers), (R.defines.IS_PACKED = !0), (C.defines.IS_PACKED = !0));
     }),
      (t.update = function (e) {
     ...
     function O(e, t, n) {
      for (var i = void 0, r = void 0, o = void 0, a = 0, s = 0, u = e.length; a < u; a++)
       (i = ((o = (e[s + 0] / F) * 0.5 + 0.5) % 1) - (r = (255 * o) % 1) / 255),
        ...
        (n[s + 0] = 255 * i),
        (n[s + 1] = 255 * r),
        (i = ((o = (e[s + 3] / z) * 0.5 + 0.5) % 1) - (r = (255 * o) % 1) / 255),
        (n[s + 2] = 255 * i),
        (n[s + 3] = 255 * r),
        (s += 4);
     }
    ...
    function (e, t, n) {
     ...
     function u(e) {
      ...
      c.constructor.call(this, a({ uniforms: u, defines: { ITERATION: t }, fragmentShader: r.precisionPrefix + n(97), blending: s.NoBlending }, e)),
    ...
    function (e, t, n) {
     ...
     function h() {
      v.constructor.call(this, {
       ...
       backgroundColor: 0,
       path: "",
       initialData: { cameraPositionZ: -2.5084, cameraRotationSpeed: -0.0011, cameraRotationX: 0, cameraRotationY: 0, cameraRotationZ: -2.5084, homeHeroBgContainerRotationZ: -1.4203, u_time: 67.539, u_initRatio: 1, u_noiseTime: 1 },
       parallax: 1.2,
       ROTATION_SPEED: 0,
       NODE_COUNT: 16,
       MAX_TUBE_COUNT: 1024,
    ...
    function (module, exports, __webpack_require__) {
     ...
     (function (global) {
      ...
      void 0 !== global && (global.numeric = numeric),
       ...
       (numeric.ops2 = { add: "+", sub: "-", mul: "*", div: "/", mod: "%", and: "&&", or: "||", eq: "===", neq: "!==", lt: "<", gt: ">", leq: "<=", geq: ">=", band: "&", bor: "|", bxor: "^", lshift: "<<", rshift: ">>", rrshift: ">>>" }),
       ...
       (numeric.eig = function (e, t) {
        ...
        for (i = 0; i < M; i++)
         if ((n = b[i][0]) === b[i][1]);
          ...
          (d = (l = -a - c) * l - 4 * (a * c - s * u)) >= 0
           ...
           : ((f = -0.5 * l),
             (h = 0.5 * P(-d)),
             (p = (a - f) * (a - f) + s * s) > (g = u * u + (c - f) * (c - f)) ? ((v = (a - f) / (p = P(p + h * h))), (m = s / p), (f = 0), (h /= p)) : ((v = u / (g = P(g + h * h))), (m = (c - f) / g), (f = h / g), (h = 0)),
             (r = new y(
              [
               [m, -v],
               [v, m],
        ...
        return (C = C.transpose()), (C = T.transjugate().dot(C)), { lambda: R.getDiag(), E: C };
       }),
       ...
       (numeric.ccsLUP1 = function (e, t) {
        ...
        for (void 0 === t && (t = 1), n = 0; n < c; ++n) {
         ...
         for (w(x[n]) < t * o && ((i = b[n]), (o = b[a]), (b[n] = o), (S[o] = n), (b[a] = i), (S[i] = a), (o = x[n]), (x[n] = x[a]), (x[a] = o)), o = f[n], a = m[n], u = x[n], h[o] = b[n], v[o] = 1, ++o, i = _.length - 1; -1 !== i; --i)
           ...
           if (((C = S[c + 1]), (M = this._at(C, u)), 0 !== T))
            if (0 === M || T * M > 0) (R = C), (T = M);
             ...
             for (var F = 0; !((I = (T * C - M * R) / (T - M)) <= R || I >= C); )
              if ((P = this._at(I, u)) * M > 0) (C = I), (M = P), -1 === F && (T *= 0.5), (F = -1);
              else {
               if (!(P * T > 0)) break;
               (R = I), (T = P), 1 === F && (M *= 0.5), (F = 1);
              }
       ...
       (numeric.uncmin = function (e, t, n, i, r, o, a) {
        ...
        for (m = i(t); z < r; ) {
         ...
         for (b = 1, c = M(m, v), x = t; z < r && !(b * S < n) && ((x = R(t, (g = A(v, b)))), (u = e(x)) - d >= 0.1 * b * c || isNaN(u)); ) (b *= 0.5), ++z;
         if (b * S < n) {
        ...
        return { solution: t, f: d, gradient: m, invHessian: T, iterations: z, message: E };
       }),
       ...
       (numeric.dopri = function (e, t, n, i, r, o, a) {
        ...
        for ("function" == typeof a && (g = a(e, n)); e < t && z < o; )
         if (
          (++z,
          e + F > t && (F = t - e),
          (s = i(e + A[0] * F, E(n, k(0.2 * F, b[L])))),
          (u = i(e + A[1] * F, E(E(n, k(T[0] * F, b[L])), k(T[1] * F, s)))),
          (c = i(e + A[2] * F, E(E(E(n, k(M[0] * F, b[L])), k(M[1] * F, s)), k(M[2] * F, u)))),
          (l = i(e + A[3] * F, E(E(E(E(n, k(P[0] * F, b[L])), k(P[1] * F, s)), k(P[2] * F, u)), k(P[3] * F, c)))),
          (d = i(e + A[4] * F, E(E(E(E(E(n, k(R[0] * F, b[L])), k(R[1] * F, s)), k(R[2] * F, u)), k(R[3] * F, c)), k(R[4] * F, l)))),
          (f = i(e + F, (m = E(E(E(E(E(n, k(b[L], F * C[0])), k(u, F * C[2])), k(c, F * C[3])), k(l, F * C[4])), k(d, F * C[5]))))),
          (p = "number" == typeof (h = E(E(E(E(E(k(b[L], F * D[0]), k(u, F * D[2])), k(c, F * D[3])), k(l, F * D[4])), k(d, F * D[5])), k(f, F * D[6]))) ? U(h) : N(h)) > r)
         ) {
          ...
          if (((S[L] = E(E(E(E(E(E(n, k(b[L], F * I[0])), k(u, F * I[2])), k(c, F * I[3])), k(l, F * I[4])), k(d, F * I[5])), k(f, F * I[6]))), (y[++L] = e + F), (w[L] = m), (b[L] = f), "function" == typeof a)) {
           ...
           if (((x = a(Y, S[L - 1])), V((_ = W(H(g, 0), H(0, x)))) || ((X = Y), (g = x), (x = a((Y = e + F), m)), (_ = W(H(g, 0), H(0, x)))), V(_))) {
            for (var Z, K, Q = 0, J = 1, $ = 1; ; ) {
             ...
             if (q <= X || q >= Y) break;
             (K = a(q, (j = G._at(q, L - 1)))), V((Z = W(H(g, 0), H(0, K)))) ? ((Y = q), (x = K), (_ = Z), ($ = 1), -1 === Q ? (J *= 0.5) : (J = 1), (Q = -1)) : ((X = q), (g = K), (J = 1), 1 === Q ? ($ *= 0.5) : ($ = 1), (Q = 1));
            }
            return (m = G._at(0.5 * (e + q), L - 1)), (G.f[L] = i(q, j)), (G.x[L] = q), (G.y[L] = j), (G.ymid[L - 1] = m), (G.events = _), (G.iterations = z), G;
           }
          }
          (e += F), (n = m), (g = x), (F = O(0.8 * F * B(r / p, 0.25), 4 * F));
         }
       ...
       (numeric.__solveLP = function (e, t, n, i, r, o, a) {
        ...
        for (c = 0; c < r; ++c) {
         ...
         var k = m(A, v(t, F)),
          O = 1;
         for (L = x - 1; -1 !== L; --L) k[L] < 0 && (O = T(O, -0.999 * k[L]));
         if (((s = h(o, f(F, O))), !M(P((A = h(n, v(t, s))), 0)))) return { solution: o, message: "", iterations: c };
       ...
       (function (e) {
        ...
        function i(e, t, n, i, r, o, a, s, u, c, l, d, f, h, v, m) {
         ...
         function G() {
          ...
          if (f === i) v[x] = v[i];
           ...
           for (
            ...
            p >= f + 1 &&
            0 !== v[p] &&
            ((z = Math.max(Math.abs(v[p - 1]), Math.abs(v[p]))),
            (E = Math.min(Math.abs(v[p - 1]), Math.abs(v[p]))),
            (A = v[p - 1] >= 0 ? Math.abs(z * Math.sqrt(1 + (E * E) / (z * z))) : -Math.abs(z * Math.sqrt(1 + (E * E) / (z * z)))),
            (z = v[p - 1] / A),
            (E = v[p] / A),
            1 !== z);
            p -= 1
           )
            if (0 === z) for (v[p - 1] = E * A, g = 1; g <= i; g += 1) (A = e[g][p - 1]), (e[g][p - 1] = e[g][p]), (e[g][p] = A);
            else for (v[p - 1] = A, k = E / (1 + z), g = 1; g <= i; g += 1) (A = z * e[g][p - 1] + E * e[g][p]), (e[g][p] = k * (e[g][p - 1] + A) - e[g][p]), (e[g][p - 1] = A);
           v[x] = v[f];
          }
          return 0;
         }
         function j() {
          ...
          if (
           ((z = Math.max(Math.abs(v[_ - 1]), Math.abs(v[_]))),
           (E = Math.min(Math.abs(v[_ - 1]), Math.abs(v[_]))),
           (A = v[_ - 1] >= 0 ? Math.abs(z * Math.sqrt(1 + (E * E) / (z * z))) : -Math.abs(z * Math.sqrt(1 + (E * E) / (z * z)))),
           (z = v[_ - 1] / A),
           (E = v[_] / A),
           1 === z)
          )
      ...
      (v.init = function () {
       ...
       if (
        ...
        (b = new i.RawShaderMaterial({
         uniforms: { u_texture: l.sharedUniforms.u_texture, u_btnOffset: w.material.uniforms.u_btnOffset, u_btnScale: w.material.uniforms.u_btnScale, u_uvOffset: l.sharedUniforms.u_uvOffset, u_uvScale: l.sharedUniforms.u_uvScale },
    ...
    function (e, t, n) {
     ...
     (t.preInit = function (e) {
      (M = e),
       a.loader.add(o.assetPath + "visuals/homeAbout/bg.buf", {
        ...
        onLoad: function (e) {
         ...
         (z = new i.BufferGeometry()).setAttribute("a_position", new i.BufferAttribute(a, 2, !0)),
          ...
          (function () {
           ...
           (T = new i.RawShaderMaterial({
            ...
            (S = new i.RawShaderMaterial({ uniforms: T.uniforms, vertexShader: s.vertexShader, fragmentShader: s.precisionPrefix + n(147), depthTest: !1, depthWrite: !1, transparent: !0, blending: i.NoBlending })),
      ...
      (t.resize = function (e, n) {
       ...
       s.clearColorRGBA(1, 0, 0.5, 0.5, p), s.setColorState(i), T.uniforms.u_randomSeed.value.set(Math.random(), Math.random(), Math.random(), Math.random()), s.render(T, m), s.render(S, p), (E = 0);
      }),
      (t.update = function (e) {
       ...
       if ((v.uniforms.u_mouse.value.set(0.5 * N(i, o) + 0.5, 0.5 * o + 0.5), t.isSimActive)) {
        ...
        for (var m = 0; m < 6; m++) U(), (w.uniforms.u_noiseUvOffset.value = (w.uniforms.u_noiseUvOffset.value + 0.1 * e) % 1), s.render(w, p);
        ...
        var S = c.clamp(i, -1, 1),
         ...
         k = Math.atan2(T, S);
        s.render(v, x), r.isMobile || (s.copy(x.texture, _), u.blur9(4, 0.5, _)), F.uniforms.u_constraintedMouse.value.set(Math.cos(k) * z, Math.sin(k) * z), (E += o <= -1 || o >= 1 ? 0.1 * (0 - E) : 0.1 * (1 - E));
        var O = (F.uniforms.u_clothEffectRatio.value = E);
        (F.uniforms.u_baseBlendRatio.value = (0.1 + 0.9 * c.clamp(c.smoothstep(0, 0.3, z), 0, 1)) * O), (l.u_rotation.value = M.expandRatio);
       }
      });
     ...
     (m.constructor = h),
      ...
      (m.init = function () {
       if (
        ...
        (S = new u.RawShaderMaterial({ uniforms: { u_texture: F.u_videoTexture }, depthTest: !1, depthWrite: !1, transparent: !0, blending: u.NoBlending, vertexShader: l.precisionPrefix + n(159), fragmentShader: l.precisionPrefix + n(29) })),
        (M = this.camera.clone()),
        (k = new u.PointLight(9282756, 0.8, 5, 2)).position.set(0, 0, 0),
        this.scene.add(k),
        (P.muted = !0),
      ...
      (m._initMaterials = function (e) {
       ...
       for (; t--; ) {
        var r = e[t],
         ...
         a = (r.material = r.originalMaterial = new u.ShaderMaterial({ uniforms: o, vertexShader: n(55), fragmentShader: n(56), lights: !0, blending: u.NoBlending, transparent: !1, dithering: !0 })),
         s = (r.reflectionMaterial = new u.ShaderMaterial({ uniforms: o, vertexShader: n(55), fragmentShader: n(56), lights: !0, blending: u.NoBlending, transparent: !1, dithering: !0 }));
        switch (((r.reflectionMaterial.defines.IS_REFLECTION = !0), r.name)) {
         case "model":
          (z = r), (o.u_normalTexture = { value: C }), (s.defines.IS_MODEL = a.defines.IS_MODEL = !0), (s.vertexColors = a.vertexColors = u.VertexColors), (s.extensions.derivatives = a.extensions.derivatives = !0);
          break;
         case "walls":
      ...
      (m.update = function (e) {
       if ((this.testViewport(), this.needsRender)) {
        ...
        m !== V && ((V = m), TweenLite.to(B.uniforms.u_showRatio, m ? 2 : 1.35, { value: m ? 1 : 0 })),
         ...
         (k.position.y = Math.max(k.position.y, 0.04)),
         O.copy(k.position),
      ...
      (a = e.geometry.attributes.position.count),
       ...
       (function (e) {
        ...
        r.setAttribute("a_glPosition", new i.BufferAttribute(o, 2)),
         ...
         (h = new i.ShaderMaterial({ uniforms: { u_glPositionOffset: { value: new i.Vector2() } }, vertexShader: n(166), fragmentShader: n(167), depthTest: !1, depthWrite: !1, blending: i.NoBlending, skinning: !0 })),
    ...
    function (e, t, n) {
     ...
     function o(e, n, o, a, s) {
      return (
       (n = n || 0), (o = o || 0), (a = a || e.naturalWidth), (s = s || e.naturalHeight), (i = t.canvas = i || document.createElement("canvas")), (r = t.ctx = r || i.getContext("2d")), (i.width = a), (i.height = s), r.drawImage(e, -n, -o), i
      );
     }
     ...
     (h.constructor = d),
      ...
      (h.update = function (e) {
       if ((this.testViewport(), this.needsRender)) {
        ...
        this.camera.position.copy(n), this.camera.rotateX(0.2 * (1 - (r.elasticMouse.y / r.height) * 2)), this.camera.rotateY(-0.2 * ((r.elasticMouse.x / r.width) * 2 - 1)), m.set(0, 0, 1), (this.camera.fov = c.mix(45, 75, 1 - t));
     ...
     (t.preInit = function (e) {
      ...
      (t.init = function () {
       if (
        ...
        (x.material.vertexShader = x.material.vertexShader.replace("void main() {", n(194).replace(/#define\sGLSLIFY\s./, "") + "\n\nvoid main() {")),
        (x.material.vertexShader = x.material.vertexShader.replace("#include <fog_vertex>", "#include <fog_vertex>\n\n" + n(195).replace(/#define\sGLSLIFY\s./, ""))),
        (x.material.fragmentShader = x.material.fragmentShader.replace("#include <lights_physical_fragment>", n(196).replace(/#define\sGLSLIFY\s./, "") + "\n\n#include <lights_physical_fragment>")),
        (x.material.fragmentShader = x.material.fragmentShader.replace("void main() {", n(197).replace(/#define\sGLSLIFY\s./, "") + "\n\nvoid main() {")),
        (x.material.fragmentShader = x.material.fragmentShader.replace("gl_FragColor = vec4( outgoingLight, diffuseColor.a );", n(198).replace(/#define\sGLSLIFY\s./, "") + "\n\ngl_FragColor = vec4( outgoingLight, diffuseColor.a );")),
        (x.receiveShadow = !0),
     ...
     (t.preInit = function (e) {
      ...
      (t.init = function () {
       ...
       if (
        ...
        ((p = new u.Mesh(t, m.overrideDefaultMaterial(new u.MeshStandardMaterial({ color: 16777215, roughness: 0.4, metalness: 0.15, side: u.DoubleSide, shadowSide: u.FrontSide }), "standard"))).customDepthMaterial = m.overrideDefaultMaterial(
     ...
     (t.preInit = function (e) {
      ...
      (t.update = function (e) {
       ...
       for (var D = 0; D < d; D++) {
        var L = c[D];
        if (L.visible) {
         L.prevDirection.copy(L.direction), L.pendingDirection.copy(L.directionForce).add(L.direction).normalize(), L.direction.copy(L.pendingDirection), L.direction.applyAxisAngle(x, 0.04 * r.simplex.noise2D(10 * D, 0.2 * _));
      ...
      if (!r.gl) {
       ...
       return (
        (n.getExtension("OES_texture_float") || n.getExtension("OES_texture_half_float")) && n.getParameter(n.MAX_VERTEX_TEXTURE_IMAGE_UNITS)
         ? ((r.renderTargetFloatType = o.isIOS || !n.getExtension("OES_texture_float") ? h.HalfFloatType : h.FloatType), (r.dataFloatType = h.FloatType), (r.useFloatPacking = !1))
         : ((r.renderTargetFloatType = r.dataFloatType = h.UnsignedByteType), (r.useFloatPacking = !0)),
        !0
       );
      }
      return !1;
     ...
     e.exports = r.GLTFLoader = (function () {
      ...
      (f.prototype.decodePrimitive = function (e, t) {
       ...
       (m.prototype.interpolate_ = function (e, t, n, i) {
        for (
         var r = this.resultBuffer, o = this.sampleValues, a = this.valueSize, s = 2 * a, u = 3 * a, c = i - t, l = (n - t) / c, d = l * l, f = d * l, h = e * u, v = h - u, m = -2 * f + 3 * d, p = f - d, g = 1 - m, x = p - d + l, _ = 0;
         _ !== a;
         _++
        ) {
         var y = o[v + _ + a],
      ...
      var p = 0,
       ...
       R = { POSITION: "position", NORMAL: "normal", TEXCOORD_0: "uv", TEXCOORD_1: "uv2", COLOR_0: "color", WEIGHTS_0: "skinWeight", JOINTS_0: "skinIndex" },
       C = { scale: "scale", translation: "position", rotation: "quaternion", weights: "morphTargetInfluences" },
      ...
      function B(e, t) {
       for (var i = 0, r = e.length; i < r; i++) {
        ...
        if (
         ...
         u && c ? u.bufferView === c.bufferView && U(u.attributes, c.attributes) : a.indices === s.indices && U(a.attributes, s.attributes))
        )
         return o.promise;
       }
       var a, s, u, c;
        ...
        var t,
         ...
         s = (function (e) {
          ...
          for (var r = 1, o = e.length; r < o; r++) {
           ...
           for (var u = 0, c = i.length; u < c; u++) if (!U(i[u], s[u])) return !1;
          }
          return !0;
         })(e);
        function u(e) {
          ...
          for (var c = 1 === u.length && u[0].groups.length > 0, l = [], d = 0, f = u.length; d < f; d++) {
           ...
           for (
            var T = c ? h.material : [h.material],
             ...
             R = !0 === h.isSkinnedMesh,
             C = Object.keys(v.morphAttributes).length > 0,
             I = C && void 0 !== v.morphAttributes.normal,
             A = 0,
             D = T.length;
            A < D;
            A++
            ...
            if (M || P || R || C) {
             ...
             var E = t.cache.get(L);
             E ||
              ((E = S.isGLTFSpecularGlossinessMaterial ? o[n.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS].cloneMaterial(S) : S.clone()),
              R && (E.skinning = !0),
              M && (E.vertexColors = r.VertexColors),
              P && (E.flatShading = !0),
              C && (E.morphTargets = !0),
              I && (E.morphNormals = !0),
              t.cache.add(L, E)),
     ...
     !(function () {
      ...
      function B(e) {
       var t,
        n = e.g.a.offsetWidth,
        i = e.h.a.offsetWidth;
       (t = n === e.f.serif && i === e.f["sans-serif"]) || (t = U() && N(e, n, i)),
        t
         ? s() - e.A >= e.w
           ? U() && N(e, n, i) && (null === e.u || e.u.hasOwnProperty(e.a.c))
             ? V(e, e.v)
             : V(e, e.B)
           : (function (e) {
              setTimeout(
