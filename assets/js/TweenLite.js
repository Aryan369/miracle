...
!(function (a, b) {
    ...
    var E = u("core.Animation", function (a, b) {
     if (
      ((this.vars = b = b || {}), (this._duration = this._totalDuration = a || 0), (this._delay = Number(b.delay) || 0), (this._timeScale = 1), (this._active = !!b.immediateRender), (this.data = b.data), (this._reversed = !!b.reversed), Z)
     ) {
      k || j.wake();
       ...
       (k = f[h]),
        ...
        k === e[h] || e.length <= h
         ...
         : (n && (l.push(n), (n = "")),
           (g = parseFloat(e[h])),
           l.push(g),
           (l._firstPT = { _next: l._firstPT, t: l, p: l.length - 1, s: g, c: ("=" === k.charAt(1) ? parseInt(k.charAt(0) + "1", 10) * parseFloat(k.substr(2)) : parseFloat(k) - g) || 0, f: 0, m: o && 4 > o ? Math.round : P })),
        (m += k.length);
      ...
      if (a >= j - n && a >= 0)
       (h._totalTime = h._time = j),
        ...
        0 === j &&
         ...
         (h._startTime === h._timeline._duration && (a = 0), (0 > k || (0 >= a && a >= -n) || (k === n && "isPause" !== h.data)) && k !== a && ((c = !0), k > n && (e = "onReverseComplete")), (h._rawPrevTime = g = !b || a || k === a ? a : n));
      else if (n > a)
